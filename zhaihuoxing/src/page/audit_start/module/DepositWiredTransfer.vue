<template lang="pug">
  .deposit_wired_transfer
    .tooltip.theme-color-C {{renderData.depositWiredTransferAttention}}
    .title.theme-color-C {{renderData.depositWiredTransferText}}
    el-form(:model="info", ref="infoForm", :rules="rules" label-width="140px", labelPosition='left')
      ...
      el-form-item(prop="amount")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.depositAmount}}
