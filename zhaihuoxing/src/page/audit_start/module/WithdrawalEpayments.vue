<template lang="pug">
  .withdraw_epayments
    .tooltip.theme-color-C {{renderData.withdrawalEpaymentsAttention}}
    .title.theme-color-C {{renderData.withdrawalEpaymentsText}}
    el-form(:model="info", ref="infoForm", :rules="rules" label-width="140px", labelPosition='left')
      ...
      el-form-item(prop="others.name")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.nameOrCompany}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.name")
      el-form-item(prop="others.epaymentsAccount")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.epaymentsAccount}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.epaymentsAccount")
      .email-tooltip {{renderData.epaymentsEmailNotes}}
