<template lang="pug">
  .withdraw_wired_transfer
    .tooltip.theme-color-C {{renderData.withdrawalWiredTransferAttention}}
    .title.theme-color-C {{renderData.withdrawalWiredTransferText}}
    el-form(:model="info", ref="infoForm", :rules="rules" label-width="140px", labelPosition='left')
      ...
      el-form-item(prop="others.cardNo")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.internationalAccountNo}}
      ...
      el-form-item(prop="others.swiftcode")
        .form-label(v-ellipsis-title="" slot="label") Swift Code
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.swiftcode")
      ...
      el-form-item(prop="others.bankAddress")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.bankAddress}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.bankAddress")
      el-form-item(prop="others.phoneNo")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.phoneNo}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.phoneNo")
      el-form-item(prop="others.email")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.email}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.email")
      el-form-item(prop="others.address")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.address}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.address")
      el-form-item(prop="others.message")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.message}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.message")
