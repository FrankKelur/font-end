<template lang="pug">
  .withdraw_skrill
    .tooltip.theme-color-C {{renderData.withdrawalSkrillAttention}}
    .title.theme-color-C {{renderData.withdrawalSkrillText}}
    el-form(:model="info", ref="infoForm", :rules="rules" label-width="140px", labelPosition='left')
      ...
      el-form-item(prop="others.skrillAccount")
        .form-label(v-ellipsis-title="" slot="label") {{renderData.skrillAccount}}
        b-input(:placeholder="renderData.pleaseEnter", :model.sync="info.others.skrillAccount")
      .email-tooltip {{renderData.skrillEmailNotes}}
